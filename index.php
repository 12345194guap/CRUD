        ...
        <div class="container">
            ...
            <div class="block_messages">
                ...
                <div class="main_message">
                    ...
                    <form class="change_likes" method = "POST" action="php/change_likes.php">
                        <button class="btn_like" type="submit">Like</button>
                        <p class="output"><?php echo $row[0]['likes'];?></p>
                        <p class="output"><?php echo $row[0]['time'];?></p>
                        <input type="hidden" value="<?php echo $row[0]['likes'];?>" name = "post_likes"></input>
                        <input type="hidden" value="<?php echo $row[0]['id'];?>" name = "id"></input>
                    </form>

                    <form class="add_comment" method = "POST" action="php/add_comment.php">
                        <textarea class="text_add_comment" rows="7" cols="30" type="text" name = "text" placeholder="Ваш комментарий..."><?php if(isset($_SESSION['comment'])) echo $_SESSION['comment']; unset($_SESSION['comment']); ?></textarea>
