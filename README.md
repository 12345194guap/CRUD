...
| :------: | :------: | :------: | :------: |
| **id** | INT  | NO | Автоматический идентификатор сообщения |
...
| Название | Тип | NULL | Описание |
| :------: | :------: | :------: | :------: |
| **message_id** | INT  | NO | Идентификатор сообщения |
| **text** | INT  | NO | Текст комментария |
| **time** | TEXT | NO | Дата создания комментария |
***
